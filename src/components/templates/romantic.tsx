...
function HeroSection({ gift, daysCount }: { gift: RomanticTemplateProps['gift']; daysCount: number }) {
    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      <div className="absolute inset-0">
        {photos.length > 0 ? (
          ...
          <div className="w-full h-full bg-gradient-to-br from-rose-950 via-rose-900 to-rose-950" />
        )}
      </div>
        ...
        {[...Array(30)].map((_, i) => (
          <motion.div
            ...
            style={{
              ...
              top: `${Math.random() * 100}%`,
              background: `rgba(251, 191, 36, ${Math.random() * 0.4 + 0.1})`,
            }}
            animate={{
      ...
      <div className="relative z-10 text-center px-6 max-w-3xl mx-auto">
        ...
        >
          <motion.div variants={fadeUp}>
            <motion.div
              className="w-px h-16 bg-gradient-to-b from-transparent via-amber-400 to-transparent mx-auto mb-8"
              initial={{ scaleY: 0 }}
              animate={{ scaleY: 1 }}
          ...
          >
            {gift.coupleName.split('&').map((name, i) => (
              <span key={i}>
                {i === 1 && (
                  <motion.span
                    className="block text-3xl md:text-4xl lg:text-5xl text-amber-300 my-2 font-light italic"
          ...
          {gift.storyTitle && (
            <motion.p
              variants={fadeUp}
              className="font-serif text-xl md:text-2xl text-amber-200/90 italic tracking-wide"
            >
              {gift.storyTitle}
            </motion.p>
          )}
          ...
          <motion.div variants={fadeUp} className="pt-8">
            ...
            >
              <div className="text-amber-300 text-sm tracking-widest mb-2">DESCUBRA NOSSA HISTÓRIA</div>
              <svg className="w-6 h-6 mx-auto text-amber-300/60" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
function StorySection({ sections, accentColor }: { sections: StorySection[]; accentColor: string }) {
  ...
  return (
    <section className="relative py-20 md:py-28">
      <div className="absolute inset-0 bg-gradient-to-b from-rose-950 to-black/90" />
...
function TimelineSection({ events, accentColor }: { events: TimelineEvent[]; accentColor: string }) {
  ...
  return (
    <section className="relative py-20 md:py-28 overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-b from-black/90 via-rose-950/30 to-black/90" />
...
function CounterSection({ daysCount, accentColor }: { daysCount: number; accentColor: string }) {
  ...
  return (
    <section ref={ref} className="relative py-24 md:py-32 overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-b from-black/90 to-rose-950/50" />
      <div
...
function PhotosSection({ photos, accentColor }: { photos: string[]; accentColor: string }) {
  ...
  return (
    <section className="relative py-20 md:py-28">
      <div className="absolute inset-0 bg-gradient-to-b from-rose-950/50 to-black/90" />
...
function LocationSection({ locationUrl, locationName, accentColor }: { locationUrl?: string; locationName?: string; accentColor: string }) {
  ...
  return (
    <section className="relative py-20 md:py-28">
      <div className="absolute inset-0 bg-gradient-to-b from-black/90 to-rose-950/30" />
...
function FooterSection({ clientName, accentColor }: { clientName?: string; accentColor: string }) {
  return (
    <footer className="relative py-24 md:py-32 overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-b from-rose-950/30 to-rose-950" />
...
export default function RomanticTemplate({ gift }: RomanticTemplateProps) {
